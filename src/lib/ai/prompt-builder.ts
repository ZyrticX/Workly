...
${!contactContext.name ? '- **השם לא ידוע!** שאלי "איך קוראים לך?" ושלחי action update_contact עם השם' : `- השם ידוע: ${contactContext.name}`}
- הצגי בקצרה את השירותים הפופולריים
- כשאוספת מידע חדש (שם, מגדר) — שלחי action מסוג update_contact
